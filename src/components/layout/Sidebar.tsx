...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full w-64 flex-col border-r border-slate-800 bg-black text-white">
      {/* 1. Logo Area - Gold Text */}
      <div className="flex h-20 items-center justify-center border-b border-slate-800 bg-black px-6">
        <div className="flex flex-col items-center">
          {/* Simulating the Begena Icon/Logo */}
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-primary text-black shadow-[0_0_15px_rgba(245,158,11,0.4)]" // Gold Active State
